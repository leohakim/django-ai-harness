...
Note: `example/.envs/` may contain **placeholder** values generated by cookiecutter-django
(`keep_local_envs_in_vcs=y`). Those are demo defaults for the golden example only—not
live credentials. Do not commit real secrets.
